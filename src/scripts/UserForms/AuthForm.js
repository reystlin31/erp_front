        ...
        return (
            <div className="block centerPage">
                ...
                <div className="footer">
                    <p className="text-center">Еще нет аккаунта? <Link className="txt-brand" to="/reg">
                     <font color='#29aafe'>Регистрируйся</font></Link></p>
                    <p className="text-center">Забыли пароль? <Link className="txt-brand" to="/passrec">
                     <font color='#29aafe'>Восстановить</font></Link></p>
                </div>
            </div>
        )
    }
